---
title: "Xaringan Demo"
subtitle: "Yihui's<br/>xaringan documentation"
author: "John Little"
institute: "Center for Data & Viz"
date: "2016/04/02 (updated: `r Sys.Date()`)"
output:
...
Slides and their styling are imbued with subjective personal taste.  You will be able to customize your slides to produce [something like this (my taste.)](https://people.duke.edu/~jrl/dashboard_wednesday/)

The important idea is to use literate coding techniques to leveage the reproducibility bias of _R Markdown_

But first, you have to get started with the basics....
